...
public class SaleDetailMapper {
    ...
    public static SaleDetailEntity toEntityCreated(SaleDetailCreate dto, ProductEntity product, SaleEntity sale) {
    ...
    public static SaleDetailEntity toEntityUpdated(SaleDetailEntity entity, SaleDetailUpdate dto, ProductEntity product, SaleEntity sale) {
        var unitPrice = product.getPrice();
        var total = unitPrice * dto.quantity();
    ...
    public static SaleDetailEntity toEntityDeleted(SaleDetailEntity entity) {
    ...
    public static SaleDetailCreated toCreated(SaleDetailEntity entity) {
        return new SaleDetailCreated(
                entity.getIdSaleDetail(),
                entity.getQuantity(),
                entity.getUnitPrice(),
                entity.getTotal(),
                entity.getProduct().getIdProduct(),
                entity.getSale().getIdSale()
        );
    }

    public static SaleDetailUpdated toUpdated(SaleDetailEntity entity) {
        return new SaleDetailUpdated(
                entity.getIdSaleDetail(),
                entity.getQuantity(),
                entity.getUnitPrice(),
                entity.getTotal(),
